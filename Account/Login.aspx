                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <div class="checkbox" style="height: 40px">
                                ...
                                <asp:Label runat="server" AssociatedControlID="RememberMe">记住密码</asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10" style="left: 0px; top: 0px; height: 78px">
                            <asp:Button runat="server" OnClick="LogIn" Text="登录" CssClass="btn btn-default" Width="95px" />
                        </div>
                    </div>
                </div>
                <p>
